...
local LsFrameP2HudN64 = {}
 ...
 for i=1, 9 do
 _G["hudAirMeter"   ..i] = Graphics.loadImage((Misc.resolveFile("hudAirMeter") or Misc.resolveFile("graphics/luaResource/LsBreathMeter/hudAirMeter"  .. i ..".png")));LsFrameHudN64[i] =  _G["hudAirMeter"   ..i]
 _G["hudP2AirMeter" ..i] = Graphics.loadImage((Misc.resolveFile("hudP2AirMeter") or Misc.resolveFile("LsBreathMeter/hudP2AirMeter".. i ..".png")));  LsFrameP2HudN64[i] =  _G["hudP2AirMeter"   ..i]
end
local hudAirMeterShape       =   Graphics.loadImage((Misc.resolveFile("hudAirMeterShape") or Misc.resolveFile("graphics/luaResource/LsBreathMeter/hudAirMeterShape.png")));  -- let's load elipse pix all parts
local hudAirMeterBackGround  =   Graphics.loadImage((Misc.resolveFile("hudAirMeterBackGround.png") or Misc.resolveFile("graphics/luaResource/LsBreathMeter/hudAirMeterBackGround.png"))); -- let's load background pix part
